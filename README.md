...
- :heavy_check_mark: REST API [:link:](https://elasticsearch.bookhub.tech/rest_apis/)
  ...
  - :heavy_check_mark: 集群 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/rest_apis/cluster_apis)
    ...
    - :heavy_check_mark: 节点移除预验证 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/cluster_apis/prevalidate_node_removal)
  ...
  - :heavy_check_mark: 连接器 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/connector_apis)
    - :heavy_check_mark: 创建连接器 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/create_connector)
    - :heavy_check_mark: 删除连接器 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/delete_connector)
    - :heavy_check_mark: 获取连接器 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/get_connector)
    - :heavy_check_mark: 列出连接器 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/list_connector)
    - :heavy_check_mark: 更新连接器 API 密钥 ID API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_api_key_id)
    - :heavy_check_mark: 更新连接器配置 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_configuration)
    - :heavy_check_mark: 更新连接器索引名称 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_index_name)
    - :heavy_check_mark: 更新连接器功能 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_features)
    - :heavy_check_mark: 更新连接器过滤 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_filtering)
    - :heavy_check_mark: 更新连接器名称和描述 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_name_description)
    - :heavy_check_mark: 更新连接器管道 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_pipeline)
    - :heavy_check_mark: 更新连接器调度 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_scheduling)
    - :heavy_check_mark: 更新连接器服务类型 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_service_type)
    - :heavy_check_mark: 创建连接器同步作业 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/create_connector_sync_job)
    - :heavy_check_mark: 取消连接器同步作业 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/cancel_connector_sync_job)
    - :heavy_check_mark: 删除连接器同步作业 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/delete_connector_sync_job)
    - :heavy_check_mark: 获取连接器同步作业 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/get_connector_sync_job)
    - :heavy_check_mark: 列出连接器同步作业 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/list_connector_sync_jobs)
    - :heavy_check_mark: 连接器签到 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/check_in_connector)
    - :heavy_check_mark: 更新连接器错误 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_error)
    - :heavy_check_mark: 更新连接器上次同步统计信息 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_last_sync)
    - :heavy_check_mark: 更新连接器状态 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/update_connector_status)
    - :heavy_check_mark: 连接器同步作业签到 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/check_in_connector_sync_job)
    - :heavy_check_mark: 认领连接器同步作业 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/claim_connector_sync_job)
    - :heavy_check_mark: 设置连接器同步作业错误 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/set_connector_sync_job_error)
    - :heavy_check_mark: 设置连接器同步作业统计信息 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/connector_apis/set_connector_sync_job_stats)
  ...
  - :heavy_check_mark: ES|QL API [:link:](https://elasticsearch.bookhub.tech/rest_apis/esql_apis/esql_apis)
    - :heavy_check_mark: ES|QL 查询 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/esql_apis/esql_query)
    - :heavy_check_mark: ES|QL 异步查询 API [:link:](https://elasticsearch.bookhub.tech/rest_apis/esql_apis/esql_async_query)
