...
* [设置 Elasticsearch](/set_up_elasticsearch/set_up_elasticsearch)
  * [安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/installing_elasticsearch)
    * [在 Linux 或 MacOS 上用压缩包安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/linux)
    * [在 Windows 上用 `.zip` 安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/windows)
    * [使用 Debian 包安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/debian)
    * [使用 RPM 安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/rpm)
    * [使用 Windows MSI 安装程序安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/msi)
    * [使用 Docker 安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/docker)
    * [使用 Homebrew 在 macOS 上安装 Elasticsearch](/set_up_elasticsearch/installing_elasticsearch/brew)
...
* [REST API](/rest_apis/rest_apis)
  ...
  * [文档 API](/rest_apis/document_apis/document_apis)
    * [索引 API](/rest_apis/document_apis/index)
