...
- :heavy_check_mark: REST API [:link:](https://elasticsearch.bookhub.zone/#/rest_apis/rest_apis)
  ...
  - :heavy_check_mark: 搜索相关 API [:link:](https://elasticsearch.bookhub.zone/#/rest_apis/search_apis/search_apis)
    ...
    - :heavy_check_mark: 多搜索模板 [:link:](https://elasticsearch.bookhub.zone/#/rest_apis/search_apis/multi_search_template)
    - :heavy_check_mark: 渲染搜索模板 [:link:](https://elasticsearch.bookhub.zone/#/rest_apis/search_apis/render_search_template)
    ...
    - Count
    - :heavy_check_mark: 验证 [:link:](https://elasticsearch.bookhub.zone/#/rest_apis/search_apis/validate)
